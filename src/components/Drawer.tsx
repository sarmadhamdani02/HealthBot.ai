  ...
  return (
    <div className=" ">
      <Disclosure as="nav">
        ...
        <div className="p-6 w-1/2 h-screen bg-[#c7fecf] bg-opacity-30 rounded-r-[20px]  backdrop-filter backdrop-blur-md fixed top-0 -left-96 lg:left-0 lg:w-60 peer-focus:left-0 peer:transition ease-out delay-150 duration-200 shadow-lg ">
