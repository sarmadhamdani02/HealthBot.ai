  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      <header className="w-full flex justify-between p-6">
        <div />
        <h1 className="text-[#00DB0F] text-3xl font-bold  absolute top-10 left-[40%]">Forget Password</h1>
      ...
      <div className="bg-white w-full max-w-sm p-8 rounded-md shadow-md text-center">
        <h2 className="text-gray-700 text-lg font-medium mb-4">Enter OTP sent to your email</h2>
